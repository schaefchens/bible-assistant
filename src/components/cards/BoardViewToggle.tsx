...
export function BoardViewToggle({ mode, onChange }: Props) {
  ...
  return (
    <div
      className="fixed left-1/2 -translate-x-1/2 z-20 flex items-center gap-1 rounded-full bg-black/60 backdrop-blur-md shadow-lg border border-surface-raised/70 px-1.5 py-1.5"
