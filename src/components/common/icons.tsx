...
export const GearIcon = ({ size = 17, stroke = 1.8, className }: IconProps & { stroke?: number }) => (
  <Glyph size={size} stroke={stroke} className={className}>
    {/* A closed cog: for each of eight teeth, out to r=9.4 across the flat
        top and back to r=6.9 across the valley, plus a hub. Straight trig on
        the 24x24 grid — the first attempt used detached radial rays and read
        unmistakably as a *brightness* icon, which is the wrong meaning in a
        settings row. Teeth have to touch the body. */}
    <path d="M18.59 9.96L21.26 10.41L21.26 13.59L18.59 14.04L18.1 15.22L19.68 17.43L17.43 19.68L15.22 18.1L14.04 18.59L13.59 21.26L10.41 21.26L9.96 18.59L8.78 18.1L6.57 19.68L4.32 17.43L5.9 15.22L5.41 14.04L2.74 13.59L2.74 10.41L5.41 9.96L5.9 8.78L4.32 6.57L6.57 4.32L8.78 5.9L9.96 5.41L10.41 2.74L13.59 2.74L14.04 5.41L15.22 5.9L17.43 4.32L19.68 6.57L18.1 8.78Z" />
