...
import { bookName, findBookByName, formatRangeList, formatReference, getBookById } from '@/services/bible/bookCatalog';
 ...
 */
function entryChapterCount(entry: ReadingEntry): number {
